<?php
$inhalt = "";
$title = "Afrika > L&auml;nder &amp; Hauptst&auml;dte";
$file = "";
...
{
$res = $db->query('SELECT `id`, `left`, `top` FROM geo WHERE typ="9" ORDER BY RANDOM();');

$bild = Project::PageRoot."/content/geographie/img.php?img=africa&amp;cord=";
$i=1;
$ida="";
while($row = $res->fetchArray())
{
$bild.=$i.':'.($row['left']-0).':'.($row['top']-0).'|';
$ida.='|'.$row['id'];
$i++;
}
