		...
		if(curTarget){
			...
			if(activeCont){
				...
				if(curTarget.style.display!='none'){
					writeHistory(curTarget, 'visible');
					curTarget.style.display  = 'none';
				}
			}
		}
...
CreateDragContainer(document.getElementById('DragContainer3'));
CreateDragContainer(document.getElementById('DragContainer4'));
CreateDragContainer(document.getElementById('DragContainer5'));
CreateDragContainer(document.getElementById('DragContainer6'));
CreateDragContainer(document.getElementById('DragContainer7'));
CreateDragContainer(document.getElementById('DragContainer8'));
CreateDragContainer(document.getElementById('DragContainer9'));
CreateDragContainer(document.getElementById('DragContainer10'));
CreateDragContainer(document.getElementById('DragContainer11'));
CreateDragContainer(document.getElementById('DragContainer12'));
CreateDragContainer(document.getElementById('DragContainer13'));
CreateDragContainer(document.getElementById('DragContainer14'));
CreateDragContainer(document.getElementById('DragContainer15'));
CreateDragContainer(document.getElementById('DragContainer16'));
CreateDragContainer(document.getElementById('DragContainer17'));
CreateDragContainer(document.getElementById('DragContainer18'));
CreateDragContainer(document.getElementById('DragContainer19'));
CreateDragContainer(document.getElementById('DragContainer20'));
CreateDragContainer(document.getElementById('DragContainer21'));
CreateDragContainer(document.getElementById('DragContainer22'));
CreateDragContainer(document.getElementById('DragContainer23'));
CreateDragContainer(document.getElementById('DragContainer24'));
CreateDragContainer(document.getElementById('DragContainer25'));
CreateDragContainer(document.getElementById('DragContainer26'));
