<?php
$inhalt = "";
$title = "Asien > L&auml;nder &amp; Hauptst&auml;dte";
$file = "";
...
{
$res = $db->query('SELECT `id`, `left`, `top` FROM geo WHERE typ="7" ORDER BY RANDOM();');

$bild = Project::PageRoot."/content/geographie/img.php?img=asia&amp;cord=";
$i=1;
$ida="";
