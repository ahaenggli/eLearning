...
{
$res = $db->query('SELECT `id`, `left`, `top` FROM geo WHERE typ="8" ORDER BY RANDOM();');

$bild = Project::PageRoot."/content/geographie/img.php?img=asiafluesse&amp;cord=";
$i=1;
$ida="";
